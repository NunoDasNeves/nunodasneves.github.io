...
(function() {
 ...
 var loadPackage = function(metadata) {
  ...
  var PACKAGE_NAME = "zig-out/web/index.data";
  ...
  function runWithFS() {
   ...
   function processPackageData(arrayBuffer) {
    ...
    Module["removeRunDependency"]("datafile_zig-out/web/index.data");
   }
   Module["addRunDependency"]("datafile_zig-out/web/index.data");
 ...
 loadPackage({
  "files": [ {
   "filename": "/assets/default_sprite.png",
   "start": 0,
   "end": 415
  }, {
   "filename": "/assets/test_areas.csv",
   "start": 415,
   "end": 1249
  }, {
   "filename": "/assets/test_characters.csv",
   "start": 1249,
   "end": 1296
  }, {
   "filename": "/assets/test_items.csv",
   "start": 1296,
   "end": 1605
  } ],
  "remote_package_size": 1605
 });
})();
...
var formatString = (format, varargs) => {
 ...
 while (1) {
  ...
  curr = SAFE_HEAP_LOAD(((textIndex) >> 0), 1, 0);
  if (curr === 0) break;
  next = SAFE_HEAP_LOAD(((textIndex + 1) >> 0), 1, 0);
  if (curr == 37) {
   ...
   if (next == 46) {
    ...
    if (next == 42) {
     ...
     while (1) {
      var precisionChr = SAFE_HEAP_LOAD(((textIndex + 1) >> 0), 1, 0);
   ...
   case "h":
    var nextNext = SAFE_HEAP_LOAD(((textIndex + 2) >> 0), 1, 0);
    if (nextNext == 104) {
     textIndex++;
     argSize = 1;
    } else {
   ...
   case "s":
    {
     ...
     if (arg) {
      for (var i = 0; i < argLength; i++) {
       ret.push(SAFE_HEAP_LOAD(((arg++) >> 0), 1, 1));
      }
     } else {
   ...
   default:
    {
     for (var i = startTextIndex; i < textIndex + 2; i++) {
      ret.push(SAFE_HEAP_LOAD(((i) >> 0), 1, 0));
     }
    }
   }
   textIndex += 2;
